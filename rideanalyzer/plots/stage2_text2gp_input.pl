...
# 84 Hour timetable
 #my @ctime =  ( 0.0000,  7.2333, 12.4000, 17.9800, 21.8000, 23.4333);
 #my @ctime2 = (27.0167, 30.1000, 32.2333, 38.2500, 44.9000);
 #my @ctime3 = (47.2333, 50.9833, 55.3167, 57.1000, 61.4333);
 #my @ctime4 = (67.8333, 74.1000, 80.5167, 84.0000, 89.0000);
...
while(<>) {
  ...
  # my $scaled = $parts[1] * 1219000.0 / 1226217.7; # mt
  # my $scaled = $parts[1]; 
  my $km = $scaled / 1000.0;
