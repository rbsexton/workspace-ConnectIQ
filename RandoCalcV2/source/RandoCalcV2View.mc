...
class RandoCalcV2View extends WatchUi.DataField {
	...
	const acp_90_lut = [
		[       0,     0, 0.004050000 ],
		[  200000,  13.5, 0.003900000 ],
		[  300000,  20.0, 0.004200000 ],
		[  400000,  27.0, 0.003900000 ],		
		[  600000,  40.0, 0.005250000 ],		
		[ 1000000,  75.0, 0.004511278 ],		
		[ 0, 0, 0 ] // Mark the end of the list.
		];
		
	const pbp_90_lut = [
		[       0,        0, 0.004000000 ],
		[  217000, 14.46667, 0.004000000 ],
		[  306000, 20.40000, 0.004277778 ],
		[  360000, 24.25000, 0.004282353 ],		
		[  445000, 30.31667, 0.004289474 ],		
		[  521000, 35.75000, 0.004280899 ],		
		[  610000, 42.10000, 0.004313253 ],		
		[  693000, 48.06667, 0.004544444 ],		
		[  783000, 54.88333, 0.004639535 ],		
		[  869000, 61.53333, 0.004611111 ],		
		[  923000, 65.68333, 0.004775281 ],		
		[ 1012000, 72.76667, 0.004964706 ],		
		[ 1097000, 79.80000, 0.005038961 ],		
		[ 1174000, 86.26667, 0.004977778 ],		
		[ 1219000, 90.00000, 0.004977778 ],		
		[ 0, 0, 0 ]
		];
		
	const pbp_84_lut = [
		[       0,        0, 0.003626728 ],
		[  217000, 13.11667, 0.003752809 ],
		[  306000, 18.68333, 0.003740741 ],
		[  360000, 22.05000, 0.003752941 ],		
		[  445000, 27.36667, 0.004000000 ],		
		[  521000, 32.43333, 0.004000000 ],		
		[  610000, 38.36667, 0.004024096 ],		
		[  693000, 43.93333, 0.004122222 ],		
		[  783000, 50.11667, 0.004313953 ],		
		[  869000, 56.30000, 0.004425926 ],		
		[  923000, 60.28333, 0.004617978 ],		
		[ 1012000, 67.13333, 0.004717647 ],		
		[ 1097000, 73.81667, 0.005025974],		
		[ 1174000, 80.26667, 0.004977778 ],		
		[ 1219000, 84.00000, 0.004977778 ],		
		[ 0, 0, 0 ] 
		];
		
	const pbp_80_lut = [
		[       0,        0, 0.003525346 ],
		[  217000, 12.75000, 0.003539326 ],
		[  306000, 18.00000, 0.003518519 ],
		[  360000, 21.16667, 0.003752941 ],		
		[  445000, 26.48333, 0.003750000 ],		
		[  521000, 31.23333, 0.003752809 ],		
		[  610000, 36.80000, 0.004024096 ],		
		[  693000, 42.36667, 0.003977778 ],		
		[  783000, 48.33333, 0.004023256 ],		
		[  869000, 54.10000, 0.004222222 ],		
		[  923000, 57.90000, 0.004292135 ],		
		[ 1012000, 64.26667, 0.004470588 ],		
		[ 1097000, 70.60000, 0.004649351 ],		
		[ 1174000, 76.56667, 0.004577778 ],		
		[ 1219000, 80.00000, 0.004577778 ],		
		[ 0, 0, 0 ] 
		];
	...
	const rusa_lut = [
		...
		[  700000,  46.66667, 0.004511278195489 ], //  46:40
		[ 1300000,  97.75000, 0.000500000000000 ], //  97:45
		[ 1900000, 158.33332, 0.000600000000000 ], // 158:20		
		[ 2500000, 300.00000, 0.000720000000000 ], // 300:00 	
		[ 0, 0, 0 ] 
		];
    ...
    function initialize() {
		...
		for( var i = 0; i < base_lut_len; i += 1 ) {
			...
			lut[i][0] = base_lut[i][0];

			// Convert from Hours to Minutes.
			lut[i][1] = base_lut[i][1] * 60.0; 
